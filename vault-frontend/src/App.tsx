  ...
  return (
    <div style={styles.root}>
      ...
      <div style={styles.container}>
        ...
        {/* Founder */}
        <div style={{ textAlign: "center", marginTop: 12, fontSize: 11, color: dark ? "rgba(255,255,255,0.25)" : "rgba(0,0,0,0.25)", letterSpacing: "0.04em", display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
          <span>FOUNDER</span>
          <a
